...
class Trainer(object):
    def __init__(self, args):
        ...
        model = FCNs(pretrained_net=vgg_model, n_class=self.nclass)
...
def main():
    parser = argparse.ArgumentParser(description="PyTorch Fully Convolutional Networks Training")
    ...
    parser.add_argument('--dataset', type=str, default='landslide',
                        choices=['pascal', 'coco', 'cityscapes','vaihingen','potsdam','landslide'],
    ...
    if args.checkname is None:
        args.checkname = 'FCN-'+str(args.backbone)
    print(args)
